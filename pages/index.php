			...
			<div class="container">
				...
				<div class="collapse navbar-collapse text-center" id="collapsenavbar">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a href="pages/aboutus.php" class="nav-link text-white">ABOUT US</a>
						</li>
						<li class="nav-item">
							<a href="pages/tours.php" class="nav-link text-white">TOURS</a>
						</li>
                        <li class="nav-item">
							<a href="pages/contactus.php" class="nav-link text-white">CONTACT US</a>
						</li>
